...
**Miscellaneous**
   - R (tidyverse, ggplot2), LaTeX (Overleaf/R Markdown/Quarto), Microsoft Office/Google docs, Google Apps Script, Git/Github, Bash.
...
-   Development of polymeric micelles capable of storing and sustainably releasing voriconazole in the lung.
...
-   Genetic transformation of roots by *A. rhizogenes*.
...
-   Isolates were characterized by genomic sequencing.
...
-   Data collection using Google Forms and development of the institute's staff database.
...
(2020) **Editor's Pick** | *EEUU* <br>
Distinction of Journal Antimicrobial Agents and Chemotherapy to the publication "A Novel Combination of CYP51A Mutations Confers Pan-Azole Resistance in *Aspergillus fumigatus*.
